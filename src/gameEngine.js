...
document.write(
  "<a href='javascript:void hint();'><img src='images/buttons/solve.gif' height=16 width=48 border=0 name='hint'></a>"
);
document.write(
  "<a href='javascript:void mix();'><img src='images/buttons/mix.gif' height=16 width=48 border=0></a>"
);
document.write(
  "<a href='javascript:void reset();'><img src='images/buttons/reset.gif' height=16 width=48 border=0></a>"
);
document.write(
  "<a href='javascript:void edit();'><img src='images/buttons/edit.gif' height=16 width=48 border=0 name='edit'></a>"
);
document.write(
  "<a href='javascript:void help();'><img src='images/buttons/help.gif' height=16 width=48 border=0></a>"
);
...
for (var i = 1; i <= 5; i++) {
  ...
  for (var j = 1; j <= 5; j++) {
    document.writeln(
      "  <td><a href='javascript:void clicked(" +
        i +
        "," +
        j +
        ");'>" +
